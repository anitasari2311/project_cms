...
#BUAT NAMPILIN KOLOM BERDASARKAN REPORT_ID YANG DIPILIH        
    ...
    @app.route('/changePassword/<data>/', methods=['POST','GET'])
    def changePassword(data):
        if request.method == 'POST':
            ...
            for x in requestData:
                ...
                passwordKonfirmasi = requestData['passwordKonfirmasi']
        ...
        try: 
            ...
            cursor.execute(' UPDATE m_user SET user_password = "'+conf_Pass+'" ')
            record = cursor.fetchall()
