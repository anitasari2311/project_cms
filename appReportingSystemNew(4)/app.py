...
def editReport():
    if session.get('user_id') is None:
        ...
        # listJudul = requests.get('http://127.0.0.1:5001/getJudulLaporan/'+kode_laporan)
        # listJudulResp = json.dumps(listJudul.json())
        # loadListJudul = json.loads(listJudulResp)
