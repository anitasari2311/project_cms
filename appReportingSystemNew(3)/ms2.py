...
class Template:
    ...
    @app.route('/saveFormatTemplate/<detailKolom>/<nama>/<posisi>/<tipe>/<lebar>/<kolomF>/<posisiF>',  methods = ['GET', 'POST'])
    def saveFormatTemplate(detailKolom, nama, posisi, tipe, lebar, kolomF, posisiF):
        ...
        try:
            ...
            for i in range (len(namaKolom)):
                try:
                    ...
                    # cursor.execute(' INSERT INTO m_detailf VALUES (%s, %s, %s, %s)', (reportId, kolomFooter[i], posisiF, ""))
                    # db.commit()
            ...
            for a in range(len(kolomFooter)):
                try:
                    cursor.execute(' INSERT INTO m_detailf VALUES (%s, %s, %s, %s)', (reportId, kolomFooter[i], posisiFooter[i], ""))
                    db.commit()
